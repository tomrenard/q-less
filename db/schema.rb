...
ActiveRecord::Schema.define(version: 2020_08_26_172730) do
  ...
  create_table "event_wishlists", force: :cascade do |t|
    t.bigint "user_id", null: false
    t.bigint "event_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["event_id"], name: "index_event_wishlists_on_event_id"
    t.index ["user_id"], name: "index_event_wishlists_on_user_id"
  end
  ...
  add_foreign_key "event_wishlists", "events"
  add_foreign_key "event_wishlists", "users"
